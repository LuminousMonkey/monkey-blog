...
For example, we can graph NVEnc vs x264 medium at a 3000kbit rate:
...
#+begin_src R :session :results output graphics :exports output :file images/2019/07/18/quake-champions-medium-3000.png
  result <- plot_vmaf(quake_champions_data[which(quake_champions_data$bitrate == 3000),], 'medium', 'false')
  orca(result, "images/2019/07/18/quake-champions-medium-3000.png")
#+end_src

#+RESULTS:

#+attr_html: :class center
[[file:images/2019/07/18/quake-champions-medium-3000.png]]
