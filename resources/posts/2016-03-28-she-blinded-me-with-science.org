...
So, I believe this video of Stuart Halloway, "[[https://youtu.be/FihU5JxmnBg][Debugging with the Scientific Method]]" is required viewing. Of course, it's not just debugging, but any sort of performance or work on a website or application. Take [[https://stackoverflow.com/][stackoverflow]] for example, it's a popular site and hosted on their own servers. I have been reading lately on their setup and the monitoring they do, not only for uptime, but for performance.
